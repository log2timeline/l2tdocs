...
== License
....
Copyright (C) 2016-2017, log2timeline projects maintainers <log2timeline-maintainers@googlegroups.com>
...
| 0.0.2 | Joachim Metz | November 2017 | Changes related to review script moving to l2tdevtools.
|===
...
....
PYTHONPATH=../l2tdevtools ../l2tdevtools/tools/review.py create
....
...
`PYTHONPATH=../l2tdevtools ../l2tdevtools/tools/review.py --diffbase=origin/feature create`.
...
....
PYTHONPATH=../l2tdevtools ../l2tdevtools/tools/review.py update
....
...
....
PYTHONPATH=../l2tdevtools ../l2tdevtools/tools/review.py merge CODEREVIEW ORGANIZATION:BRANCH
....
...
....
PYTHONPATH=../l2tdevtools ../l2tdevtools/tools/review.py close BRANCH
....
