...
* [dfTimewolf](https://github.com/log2timeline/l2tscaffolder) does not follow the naming rules, directly following the [Google Python Style Guide](https://google.github.io/styleguide/pyguide.html) instead.
